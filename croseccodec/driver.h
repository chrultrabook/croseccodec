#if !defined(_CROSECCODEC_H_)
#define _CROSECCODEC_H_
...
#include "croseccodec.h"

//
// String definitions
//

#define DRIVERNAME                 "croseccodec.sys: "

#define CROSECCODEC_POOL_TAG            (ULONG) 'CRAU'
#define CROSECCODEC_HARDWARE_IDS        L"CoolStar\\GOOG0012\0\0"
#define CROSECCODEC_HARDWARE_IDS_LENGTH sizeof(CROSECCODEC_HARDWARE_IDS)
...
WDF_DECLARE_CONTEXT_TYPE_WITH_NAME(CROSECCODEC_CONTEXT, GetDeviceContext)
...
EVT_WDF_DRIVER_UNLOAD CrosEcCodecDriverUnload;

EVT_WDF_DRIVER_DEVICE_ADD CrosEcCodecEvtDeviceAdd;

EVT_WDF_IO_QUEUE_IO_INTERNAL_DEVICE_CONTROL CrosEcCodecEvtInternalDeviceControl;
...
#else
#define CrosEcCodecPrint(dbglevel, fmt, ...) {                       \
}
#endif
#endif